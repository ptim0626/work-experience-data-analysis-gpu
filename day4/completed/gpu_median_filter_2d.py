#!/usr/bin/env python3
"""
GPU median filter for 2D images.

This script shows the complete implementation of GPU kernels for median
...
def gpu_median_filter(image_stack, window_size=3):
    ...
    median_filter_kernel = cp.RawKernel(kernel_code, "median_filter_2d")
    ...
    for img_idx in range(num_images):
        ...
        median_filter_kernel(blocks_per_grid,
                             ...
                             (d_input_stack[img_idx],
                              ...
                              in_height, in_width, window_size)
                             )
